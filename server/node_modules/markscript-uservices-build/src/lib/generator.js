    ...
    return u.generateServiceSpecs(modules, function (decorator) {
        ...
        if (member.decorators) {
            var mlEvent = member.decorators.filter(function (decorator) {
                return decorator.decoratorType.name === 'mlEvent';
            })[0];
            if (mlEvent) {
        ...
        onService: function (serviceSpec) {
            ...
            return {
                ...
                onEvent: function (event) {
                    var states;
                    if (!event.states) {
                        states = [MarkScript.TRIGGER_STATE.CREATE, MarkScript.TRIGGER_STATE.MODIFY];
                    }
